...
public class EditPatientInfoActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(this,
            ...
            EditPatientInfoActivity.DownloadTextTask runner = new EditPatientInfoActivity.DownloadTextTask();
            runner.execute(URL);
        }
    }
    ...
    public void setupNavigation(){
        ...
        ActionBarDrawerToggle actionBarDrawerToggle = new ActionBarDrawerToggle(EditPatientInfoActivity.this,
                drawerLayout,
                toolbar,
                R.string.open,
                R.string.close);
    ...
    public boolean onNavigationItemSelected(@NonNull @NotNull MenuItem item) {
        if(item.getItemId() == R.id.nav_home){
            Intent intent = new Intent(EditPatientInfoActivity.this, PatientHomeActivity.class);
            ...
            Intent intent = new Intent(EditPatientInfoActivity.this, MakeCheckActivity.class);
            intent.putExtra("fullnameData", fullname);
            intent.putExtra("emailData", email);
            intent.putExtra("roleData",role);
            intent.putExtra("patientIdData", patientId);
            ...
            Intent intent = new Intent(EditPatientInfoActivity.this, LastCheckActivity.class);
            intent.putExtra("fullnameData", fullname);
            intent.putExtra("emailData", email);
            intent.putExtra("roleData",role);
            intent.putExtra("patientIdData", patientId);
            ...
            Intent intent = new Intent(EditPatientInfoActivity.this, ListOfChecksActivity.class);
            intent.putExtra("fullnameData", fullname);
            intent.putExtra("emailData", email);
            intent.putExtra("roleData",role);
            intent.putExtra("patientIdData", patientId);
            ...
            Intent intent = new Intent(EditPatientInfoActivity.this, ListOfEmergencyActivity.class);
            intent.putExtra("fullnameData", fullname);
            intent.putExtra("emailData", email);
            intent.putExtra("roleData",role);
            intent.putExtra("patientIdData", patientId);
            ...
            Intent intent = new Intent(EditPatientInfoActivity.this, NormalCaseActivity.class);
            intent.putExtra("fullnameData", fullname);
            intent.putExtra("emailData", email);
            intent.putExtra("roleData",role);
            intent.putExtra("patientIdData", patientId);
            ...
            Intent intent = new Intent(EditPatientInfoActivity.this, PatientProfileActivity.class);
            intent.putExtra("fullnameData", fullname);
            intent.putExtra("emailData", email);
            intent.putExtra("roleData",role);
            intent.putExtra("patientIdData", patientId);
            ...
            Intent intent = new Intent(EditPatientInfoActivity.this, EditPatientInfoActivity.class);
            intent.putExtra("fullnameData", fullname);
            intent.putExtra("emailData", email);
            intent.putExtra("roleData",role);
            intent.putExtra("patientIdData", patientId);
            ...
            Intent intent = new Intent(EditPatientInfoActivity.this, LoginActivity.class);
            startActivity(intent);
            finish();
        }
        drawerLayout.closeDrawer(GravityCompat.START);
...
//                        String email = objects[2];
    ...
    public void changeInfo_btn_onClick(View view) {
        Intent intent = new Intent(EditPatientInfoActivity.this, EditInformationPatientActivity.class);
        intent.putExtra("fullnameData", fullname);
        intent.putExtra("emailData", email);
        intent.putExtra("roleData",role);
        intent.putExtra("patientIdData", patientId);
    ...
    public void resetPassword_Btn_OnClick(View view) {
        Intent intent = new Intent(EditPatientInfoActivity.this, ResetPasswordPatientActivity.class);
        intent.putExtra("fullnameData", fullname);
        intent.putExtra("emailData", email);
        intent.putExtra("roleData",role);
        intent.putExtra("patientIdData", patientId);

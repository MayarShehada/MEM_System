...
public class ParamedicProfileActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_paramedic_profile);
        ...
        if (ContextCompat.checkSelfPermission(this,
            ...
            ParamedicProfileActivity.DownloadTextTask runner = new ParamedicProfileActivity.DownloadTextTask();
            runner.execute(URL);
        }
    }
    ...
    public void setupNavigation(){
        ...
        ActionBarDrawerToggle actionBarDrawerToggle = new ActionBarDrawerToggle(ParamedicProfileActivity.this,
                drawerLayout,
                toolbar,
                R.string.open,
                R.string.close);
    ...
    public boolean onNavigationItemSelected(@NonNull @NotNull MenuItem item) {
        if(item.getItemId() == R.id.nav_home){
            ...
            Intent intent = new Intent(ParamedicProfileActivity.this, ParamedicProfileActivity.class);
            intent.putExtra("fullnameData", fullname);
            intent.putExtra("emailData", email);
            startActivity(intent);
            finish();
            ...
            Intent intent = new Intent(ParamedicProfileActivity.this, LoginActivity.class);
            startActivity(intent);
            finish();
        }
        drawerLayout.closeDrawer(GravityCompat.START);

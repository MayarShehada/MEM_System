...
public class EmergencyChecksAdapter  extends RecyclerView.Adapter<EmergencyChecksAdapter.ViewHolder> {

    private Context context;
    private List<Check> checks;

    public EmergencyChecksAdapter(Context context, List<Check> checks) {
    ...
    @NonNull
    @Override
    public EmergencyChecksAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

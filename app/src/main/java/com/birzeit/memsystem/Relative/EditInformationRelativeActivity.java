...
public class EditInformationRelativeActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{

    public TextView name_edt, email_edt, phone_edt, gender_edt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_information_relative);
        ...
        if (ContextCompat.checkSelfPermission(this,
            ...
            EditInformationRelativeActivity.DownloadTextTask runner = new EditInformationRelativeActivity.DownloadTextTask();
            runner.execute(URL);
        }
    }
    ...
    public void setupNavigation(){
        ...
        ActionBarDrawerToggle actionBarDrawerToggle = new ActionBarDrawerToggle(EditInformationRelativeActivity.this,
                drawerLayout,
                toolbar,
                R.string.open,
                R.string.close);
    ...
    public boolean onNavigationItemSelected(@NonNull @NotNull MenuItem item) {
        if(item.getItemId() == R.id.nav_home){
            ...
            Intent intent = new Intent(EditInformationRelativeActivity.this, RelativeHomeActivity.class);
            ...
            Intent intent = new Intent(EditInformationRelativeActivity.this, ListOfChecksActivity.class);
            intent.putExtra("fullnameData", fullname);
            intent.putExtra("emailData", email);
            startActivity(intent);
            finish();
            ...
            Intent intent = new Intent(EditInformationRelativeActivity.this, RelativeProfileActivity.class);
            intent.putExtra("fullnameData", fullname);
            intent.putExtra("emailData", email);
            startActivity(intent);
            finish();
            ...
            Intent intent = new Intent(EditInformationRelativeActivity.this, EditRelativeInfoActivity.class);
            intent.putExtra("fullnameData", fullname);
            intent.putExtra("emailData", email);
            startActivity(intent);
            finish();
            ...
            Intent intent = new Intent(EditInformationRelativeActivity.this, LoginActivity.class);
            startActivity(intent);
            finish();
        }
        drawerLayout.closeDrawer(GravityCompat.START);

...
public class EditRelativeInfoActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_relative_info);
        ...
        if (ContextCompat.checkSelfPermission(this,
            ...
            EditRelativeInfoActivity.DownloadTextTask runner = new EditRelativeInfoActivity.DownloadTextTask();
            runner.execute(URL);
        }
    }
    ...
    public void setupNavigation(){
        ...
        ActionBarDrawerToggle actionBarDrawerToggle = new ActionBarDrawerToggle(EditRelativeInfoActivity.this,
                drawerLayout,
                toolbar,
                R.string.open,
                R.string.close);
    ...
    public boolean onNavigationItemSelected(@NonNull @NotNull MenuItem item) {
        if(item.getItemId() == R.id.nav_home){
            ...
            Intent intent = new Intent(EditRelativeInfoActivity.this, RelativeHomeActivity.class);
            ...
            Intent intent = new Intent(EditRelativeInfoActivity.this, ListOfChecksActivity.class);
            intent.putExtra("fullnameData", fullname);
            intent.putExtra("emailData", email);
            startActivity(intent);
            finish();
            ...
            Intent intent = new Intent(EditRelativeInfoActivity.this, RelativeProfileActivity.class);
            intent.putExtra("fullnameData", fullname);
            intent.putExtra("emailData", email);
            startActivity(intent);
            finish();
            ...
            Intent intent = new Intent(EditRelativeInfoActivity.this, EditRelativeInfoActivity.class);
            intent.putExtra("fullnameData", fullname);
            intent.putExtra("emailData", email);
            startActivity(intent);
            finish();
